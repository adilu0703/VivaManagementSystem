...
<body style="color: red ; text-align: center; font-style: bold;" >
        ...
        <div class="header" style="color: white;"> STUDENT SIGN IN - VIVA MANAGEMENT SYSTEM </div>
...
<div class="login">
  ...
  <h2 class="login-header"> Student Log in</h2>

                         <form class="login-container" action="slogindb.php"  method="post">
                           ...
                           <!--  <input id="b1" type="submit" value="Login"> -->
                            ...
                            <p>Not registered? <a href="studentregistrationform.php">Create an Account</a><p>
                        </form>
                     </div>
